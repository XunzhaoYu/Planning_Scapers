...
def inverse_index(start_dir=1, end_dir=424):
    ...
    """
    csv_files = get_csv_files(get_data_storage_path(), start_dir=start_dir-1, end_dir=end_dir)
...
def append_by_year(start_dir=1, end_dir=424):
    ...
    for dir in range(start_dir-1, end_dir):
        csv_files = get_csv_files(get_data_storage_path(), start_dir=dir, end_dir=dir+1)
